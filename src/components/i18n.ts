...
const resources = {
  ...
  hi: {
    ...
    "aboutTheAppTitle": "ऐप के बारे में",
      ...
      progress: "प्रगति",
      restartRequiredTitle: "पुनः आरंभ आवश्यक",
...
    "aboutTheAppTitle": "Acerca de la aplicación",
      ...
      progress: "Progreso",
      restartRequiredTitle: "Es necesario reiniciar",
...
    "aboutTheAppTitle": "앱 정보",
      ...
      progress: "진행 상황",
      restartRequiredTitle: "다시 시작이 필요합니다",
...
    "aboutTheAppTitle": "Sobre o Aplicativo",
      ...
      progress: "Progresso",
      restartRequiredTitle: "Reinício necessário",
...
    aboutTheAppTitle: "Tokante e App",
  ...
  "aboutTheAppTitle": "Về ứng dụng",
      ...
      progress: "Tiến độ",
      restartRequiredTitle: "Cần khởi động lại",
...
      aboutTheAppTitle: "Momba ny Fampiharana",
      ...
      restartRequiredTitle: "Mila averina ny fandefasana",
  ...
  da: {
    ...
    aboutTheAppTitle: "Om appen",
      ...
      progress: "Fremgang",
      restartRequiredTitle: "Genstart påkrævet",
  ...
  bn: {
    translation: {
      ...
      progress: "অগ্রগতি",
      restartRequiredTitle: "পুনরায় চালু করা প্রয়োজন",
  ...
  id: {
    translation: {
      ...
      progress: "Kemajuan",
      restartRequiredTitle: "Perlu dimulai ulang",
  ...
  te: {
    translation: {
      ...
      progress: "పురోగతి",
      restartRequiredTitle: "పునఃప్రారంభం అవసరం",
  ...
  pa: {
    translation: {
      ...
      progress: "ਤਰੱਕੀ",
      restartRequiredTitle: "ਮੁੜ ਚਾਲੂ ਕਰਨਾ ਲੋੜੀਂਦਾ ਹੈ",
  ...
  fa: {
    translation: {
      ...
      progress: "پیشرفت",
      restartRequiredTitle: "نیاز به راه‌اندازی مجدد",
...
/**
 * Validation is intentionally kept as a nested resource. Screens retain one of
 * these keys in state and resolve it during render, which keeps an existing
 * inline error reactive when the active language changes.
 */
const validationMessages: Record<string, Record<string, string>> = {
  en: {
    nameRequired: "Name is required.",
    fieldRequired: "{{field}} is required.",
    nameInvalid: "Name must start with a letter and cannot be numbers only.",
    ageRange: "Age must be between {{min}} and {{max}}.",
    heightFtInRequired: "Height (ft/in) is required.",
    selectOption: "Please select an option to continue.",
    completeQuestions: "Please complete all questions before proceeding.",
    interestRequired: "Please select at least one interest.",
    nameAndEmailRequired: "Name and email are required.",
    emailInvalid: "Please enter a valid email address.",
    emailRequired: "Email is required.",
    passwordRequired: "Password is required.",
    passwordMinLength: "Password must be at least {{min}} characters.",
    otpSixDigits: "OTP must be a 6-digit code.",
    newPasswordMinLength: "New password must be at least {{min}} characters.",
    verificationCodeRequired: "Verification code is required.",
  },
  ta: {
    nameRequired: "பெயர் அவசியம்.",
    fieldRequired: "{{field}} அவசியம்.",
    nameInvalid: "பெயர் ஒரு எழுத்தில் தொடங்க வேண்டும்; எண்கள் மட்டும் இருக்கக் கூடாது.",
    ageRange: "வயது {{min}} மற்றும் {{max}} க்கு இடையில் இருக்க வேண்டும்.",
    heightFtInRequired: "உயரம் (அடி/அங்குலம்) அவசியம்.",
    selectOption: "தொடர ஒரு விருப்பத்தைத் தேர்ந்தெடுக்கவும்.",
    completeQuestions: "தொடர்வதற்கு முன் அனைத்து கேள்விகளையும் முடிக்கவும்.",
    interestRequired: "குறைந்தது ஒரு விருப்பத்தையாவது தேர்ந்தெடுக்கவும்.",
    nameAndEmailRequired: "பெயரும் மின்னஞ்சலும் அவசியம்.",
    emailInvalid: "சரியான மின்னஞ்சல் முகவரியை உள்ளிடவும்.",
    emailRequired: "மின்னஞ்சல் அவசியம்.",
    passwordRequired: "கடவுச்சொல் அவசியம்.",
    passwordMinLength: "கடவுச்சொல் குறைந்தது {{min}} எழுத்துகளாக இருக்க வேண்டும்.",
    otpSixDigits: "OTP 6 இலக்கக் குறியீடாக இருக்க வேண்டும்.",
    newPasswordMinLength: "புதிய கடவுச்சொல் குறைந்தது {{min}} எழுத்துகளாக இருக்க வேண்டும்.",
    verificationCodeRequired: "சரிபார்ப்புக் குறியீடு அவசியம்.",
  },
  hi: { nameRequired: "नाम ज़रूरी है।", fieldRequired: "{{field}} ज़रूरी है।", nameInvalid: "नाम एक अक्षर से शुरू होना चाहिए और केवल संख्या नहीं हो सकती।", ageRange: "उम्र {{min}} और {{max}} के बीच होनी चाहिए।", heightFtInRequired: "ऊँचाई (फीट/इंच) आवश्यक है।", selectOption: "कृपया जारी रखने के लिए कोई विकल्प चुनें।", completeQuestions: "कृपया आगे बढ़ने से पहले सभी सवालों को पूरा करें।", interestRequired: "कृपया कम-से-कम एक दिलचस्पी चुनें।", nameAndEmailRequired: "नाम और ईमेल डालना ज़रूरी है।", emailInvalid: "कृपया एक मान्य ईमेल पता डालें।", emailRequired: "ईमेल डालना ज़रूरी है।", passwordRequired: "पासवर्ड ज़रूरी है।", passwordMinLength: "पासवर्ड कम-से-कम {{min}} कैरेक्टर का होना चाहिए।", otpSixDigits: "ओटीपी 6 अंकों का कोड होना चाहिए।", newPasswordMinLength: "नया पासवर्ड कम-से-कम {{min}} कैरेक्टर का होना चाहिए।", verificationCodeRequired: "वेरिफ़िकेशन कोड ज़रूरी है।" },
  es: { nameRequired: "El nombre es obligatorio.", fieldRequired: "{{field}} es obligatorio.", nameInvalid: "El nombre debe comenzar con una letra y no pueden ser solo números.", ageRange: "La edad debe estar entre {{min}} y {{max}}.", heightFtInRequired: "Se requiere altura (pies/pulgadas).", selectOption: "Selecciona una opción para continuar.", completeQuestions: "Complete todas las preguntas antes de continuar.", interestRequired: "Selecciona al menos un interés.", nameAndEmailRequired: "El nombre y el correo electrónico son obligatorios.", emailInvalid: "Introduce una dirección de correo electrónico válida.", emailRequired: "El correo electrónico es obligatorio.", passwordRequired: "La contraseña es obligatoria.", passwordMinLength: "La contraseña debe tener al menos {{min}} caracteres.", otpSixDigits: "OTP debe ser un código de 6 dígitos.", newPasswordMinLength: "La nueva contraseña debe tener al menos {{min}} caracteres.", verificationCodeRequired: "El código de verificación es obligatorio." },
  ja: { nameRequired: "名前が必要です。", fieldRequired: "{{field}}は必須です。", nameInvalid: "名前は文字で始まる必要があり、数字のみにすることはできません。", ageRange: "年齢は{{min}}から{{max}}の間でなければなりません。", heightFtInRequired: "高さ（フィート/インチ）が必要です。", selectOption: "続行するには、オプションを選択してください。", completeQuestions: "続行する前に、すべての質問に回答してください。", interestRequired: "少なくとも1つの興味/関心を選択してください。", nameAndEmailRequired: "名前とメールアドレスが必要です。", emailInvalid: "有効なメールアドレスを入力してください。", emailRequired: "メールアドレスは必須です。", passwordRequired: "パスワードが必要です。", passwordMinLength: "パスワードは{{min}}文字以上でなければなりません。", otpSixDigits: "OTPは6桁のコードでなければなりません。", newPasswordMinLength: "新しいパスワードは{{min}}文字以上でなければなりません。", verificationCodeRequired: "認証コードが必要です。" },
  fr: { nameRequired: "Le nom est obligatoire.", fieldRequired: "{{field}} est obligatoire.", nameInvalid: "Le nom doit commencer par une lettre et ne peut pas être composé uniquement de chiffres.", ageRange: "L'âge doit être compris entre {{min}} et {{max}}.", heightFtInRequired: "La hauteur (pi/po) est requise.", selectOption: "Veuillez sélectionner une option pour continuer.", completeQuestions: "Veuillez répondre à toutes les questions avant de continuer.", interestRequired: "Veuillez sélectionner au moins un intérêt.", nameAndEmailRequired: "Le nom et l'adresse e-mail sont obligatoires.", emailInvalid: "Veuillez saisir une adresse e-mail valide.", emailRequired: "Une adresse e-mail est requise.", passwordRequired: "Le mot de passe est requis.", passwordMinLength: "Le mot de passe doit comporter au moins {{min}} caractères.", otpSixDigits: "OTP doit être un code à 6 chiffres.", newPasswordMinLength: "Le nouveau mot de passe doit comporter au moins {{min}} caractères.", verificationCodeRequired: "Le code de vérification est requis." },
  zh: { nameRequired: "姓名为必填项。", fieldRequired: "{{field}}为必填项。", nameInvalid: "名称必须以字母开头，不能仅为数字。", ageRange: "年龄必须介于{{min}}和{{max}}之间。", heightFtInRequired: "高度（英尺/英寸）是必需的。", selectOption: "请选择一个选项以继续。", completeQuestions: "请在继续之前完成所有问题。", interestRequired: "请至少选择一个兴趣。", nameAndEmailRequired: "姓名和电子邮箱为必填项。", emailInvalid: "请输入有效的电子邮件地址。", emailRequired: "电子邮箱为必填项。", passwordRequired: "密码为必填项。", passwordMinLength: "密码必须至少为{{min}}个字符。", otpSixDigits: "一次性密码必须是6位数代码。", newPasswordMinLength: "新密码必须至少为{{min}}个字符。", verificationCodeRequired: "验证码为必填项。" },
  ko: { nameRequired: "이름은 필수입니다.", fieldRequired: "{{field}}은(는) 필수입니다.", nameInvalid: "이름은 문자로 시작해야 하며 숫자만 사용할 수 없습니다.", ageRange: "연령은 {{min}} ~ {{max}} 사이여야 합니다.", heightFtInRequired: "높이(피트/인치)가 필요합니다.", selectOption: "계속하려면 옵션을 선택하세요.", completeQuestions: "계속 진행하기 전에 모든 질문을 완료해주세요.", interestRequired: "하나 이상의 관심사를 선택하세요.", nameAndEmailRequired: "이름과 이메일이 필요합니다.", emailInvalid: "유효한 이메일 주소를 입력하세요.", emailRequired: "이메일이 필요합니다.", passwordRequired: "비밀번호가 필요합니다.", passwordMinLength: "비밀번호는 {{min}}자 이상이어야 합니다.", otpSixDigits: "OTP는 6자리 코드여야 합니다.", newPasswordMinLength: "새 비밀번호는 {{min}}자 이상이어야 합니다.", verificationCodeRequired: "인증 코드가 필요합니다." },
  ru: { nameRequired: "Требуется имя.", fieldRequired: "Поле «{{field}}» обязательно.", nameInvalid: "Имя должно начинаться с буквы и не может состоять только из цифр.", ageRange: "Возраст должен быть от {{min}} до {{max}}.", heightFtInRequired: "Требуется указать рост (футы/дюймы).", selectOption: "Выберите вариант, чтобы продолжить.", completeQuestions: "Прежде чем продолжить, ответьте на все вопросы.", interestRequired: "Выберите хотя бы один интерес.", nameAndEmailRequired: "Укажите имя и адрес электронной почты.", emailInvalid: "Введите действительный адрес электронной почты.", emailRequired: "Требуется адрес электронной почты.", passwordRequired: "Требуется пароль.", passwordMinLength: "Пароль должен содержать не менее {{min}} символов.", otpSixDigits: "OTP должен быть 6-значным кодом.", newPasswordMinLength: "Новый пароль должен содержать не менее {{min}} символов.", verificationCodeRequired: "Требуется код подтверждения." },
  pt: { nameRequired: "O nome é obrigatório.", fieldRequired: "{{field}} é obrigatório.", nameInvalid: "O nome deve começar com uma letra e não pode ser apenas números.", ageRange: "A idade deve estar entre {{min}} e {{max}}.", heightFtInRequired: "A altura (pés/pol.) é obrigatória.", selectOption: "Selecione uma opção para continuar.", completeQuestions: "Responda a todas as perguntas antes de continuar.", interestRequired: "Selecione pelo menos um interesse.", nameAndEmailRequired: "Nome e e-mail são obrigatórios.", emailInvalid: "Introduza um endereço de e-mail válido.", emailRequired: "O e-mail é obrigatório.", passwordRequired: "A senha é obrigatória.", passwordMinLength: "A senha deve ter pelo menos {{min}} caracteres.", otpSixDigits: "OTP deve ser um código de 6 dígitos.", newPasswordMinLength: "A nova senha deve ter pelo menos {{min}} caracteres.", verificationCodeRequired: "O código de verificação é obrigatório." },
  de: { nameRequired: "Name ist erforderlich.", fieldRequired: "{{field}} ist erforderlich.", nameInvalid: "Der Name muss mit einem Buchstaben beginnen und darf nicht nur aus Zahlen bestehen.", ageRange: "Das Alter muss zwischen {{min}} und {{max}} liegen.", heightFtInRequired: "Höhe (ft/in) ist erforderlich.", selectOption: "Bitte wähle eine Option aus, um fortzufahren.", completeQuestions: "Bitte beantworte alle Fragen, bevor du fortfährst.", interestRequired: "Bitte wähle mindestens ein Interesse aus.", nameAndEmailRequired: "Name und E-Mail-Adresse sind erforderlich.", emailInvalid: "Bitte gib eine gültige E-Mail-Adresse ein.", emailRequired: "E-Mail-Adresse ist erforderlich.", passwordRequired: "Passwort ist erforderlich.", passwordMinLength: "Das Passwort muss mindestens {{min}} Zeichen lang sein.", otpSixDigits: "OTP muss ein 6-stelliger Code sein.", newPasswordMinLength: "Das neue Passwort muss mindestens {{min}} Zeichen lang sein.", verificationCodeRequired: "Verifizierungscode ist erforderlich." },
  vi: { nameRequired: "Tên là bắt buộc.", fieldRequired: "{{field}} là bắt buộc.", nameInvalid: "Tên phải bắt đầu bằng một chữ cái và không thể chỉ là số.", ageRange: "Tuổi phải nằm trong khoảng từ {{min}} đến {{max}}.", heightFtInRequired: "Chiều cao (ft/in) là bắt buộc.", selectOption: "Vui lòng chọn một tùy chọn để tiếp tục.", completeQuestions: "Vui lòng hoàn thành tất cả các câu hỏi trước khi tiếp tục.", interestRequired: "Vui lòng chọn ít nhất một sở thích.", nameAndEmailRequired: "Tên và email là bắt buộc.", emailInvalid: "Vui lòng nhập địa chỉ email hợp lệ.", emailRequired: "Email là bắt buộc.", passwordRequired: "Mật khẩu là bắt buộc.", passwordMinLength: "Mật khẩu phải có ít nhất {{min}} ký tự.", otpSixDigits: "OTP phải là mã gồm 6 chữ số.", newPasswordMinLength: "Mật khẩu mới phải có ít nhất {{min}} ký tự.", verificationCodeRequired: "Mã xác minh là bắt buộc." },
  mg: { nameRequired: "Ilaina ny anarana.", fieldRequired: "Ilaina ny {{field}}.", nameInvalid: "Tsy maintsy manomboka amin'ny litera ny anarana ary tsy afaka isa fotsiny.", ageRange: "Tokony ho eo anelanelan'ny {{min}} sy {{max}} ny taona.", heightFtInRequired: "Ilaina ny haavony (ft/in).", selectOption: "Misafidiana safidy iray raha hanohy.", completeQuestions: "Fenoy ny fanontaniana rehetra alohan'ny hanohizana.", interestRequired: "Misafidiana zavatra mahaliana iray farafahakeliny.", nameAndEmailRequired: "Ilaina ny anarana sy ny mailaka.", emailInvalid: "Ampidiro ny adiresy mailaka manan-kery.", emailRequired: "Ilaina ny mailaka.", passwordRequired: "Ilaina ny tenimiafina.", passwordMinLength: "Tokony hanana tarehintsoratra {{min}} farafahakeliny ny tenimiafina.", otpSixDigits: "Tokony ho kaody 6 isa ny OTP.", newPasswordMinLength: "Tokony hanana tarehintsoratra {{min}} farafahakeliny ny tenimiafina vaovao.", verificationCodeRequired: "Ilaina ny kaody fanamarinana." },
  da: { nameRequired: "Navn er påkrævet.", fieldRequired: "{{field}} er påkrævet.", nameInvalid: "Navnet skal begynde med et bogstav og må ikke kun bestå af tal.", ageRange: "Alderen skal være mellem {{min}} og {{max}}.", heightFtInRequired: "Højde (ft/in) er påkrævet.", selectOption: "Vælg en mulighed for at fortsætte.", completeQuestions: "Besvar alle spørgsmål, før du fortsætter.", interestRequired: "Vælg mindst én interesse.", nameAndEmailRequired: "Navn og e-mail er påkrævet.", emailInvalid: "Indtast en gyldig e-mailadresse.", emailRequired: "E-mail er påkrævet.", passwordRequired: "Adgangskode er påkrævet.", passwordMinLength: "Adgangskoden skal være mindst {{min}} tegn lang.", otpSixDigits: "OTP skal være en kode på 6 cifre.", newPasswordMinLength: "Den nye adgangskode skal være mindst {{min}} tegn lang.", verificationCodeRequired: "Bekræftelseskode er påkrævet." },
  bn: { nameRequired: "নাম আবশ্যক।", fieldRequired: "{{field}} আবশ্যক।", nameInvalid: "নামটি একটি অক্ষর দিয়ে শুরু হতে হবে এবং শুধু সংখ্যা হতে পারবে না।", ageRange: "বয়স অবশ্যই {{min}} এবং {{max}}-এর মধ্যে হতে হবে।", heightFtInRequired: "উচ্চতা (ফুট/ইঞ্চি) আবশ্যক।", selectOption: "চালিয়ে যেতে একটি বিকল্প নির্বাচন করুন।", completeQuestions: "এগিয়ে যাওয়ার আগে সব প্রশ্ন সম্পূর্ণ করুন।", interestRequired: "অন্তত একটি আগ্রহ নির্বাচন করুন।", nameAndEmailRequired: "নাম এবং ইমেইল আবশ্যক।", emailInvalid: "একটি বৈধ ইমেইল ঠিকানা লিখুন।", emailRequired: "ইমেইল আবশ্যক।", passwordRequired: "পাসওয়ার্ড আবশ্যক।", passwordMinLength: "পাসওয়ার্ডে কমপক্ষে {{min}}টি অক্ষর থাকতে হবে।", otpSixDigits: "OTP অবশ্যই ৬ সংখ্যার কোড হতে হবে।", newPasswordMinLength: "নতুন পাসওয়ার্ডে কমপক্ষে {{min}}টি অক্ষর থাকতে হবে।", verificationCodeRequired: "যাচাইকরণ কোড আবশ্যক।" },
  id: { nameRequired: "Nama wajib diisi.", fieldRequired: "{{field}} wajib diisi.", nameInvalid: "Nama harus dimulai dengan huruf dan tidak boleh hanya berisi angka.", ageRange: "Usia harus antara {{min}} dan {{max}}.", heightFtInRequired: "Tinggi badan (ft/in) wajib diisi.", selectOption: "Pilih opsi untuk melanjutkan.", completeQuestions: "Selesaikan semua pertanyaan sebelum melanjutkan.", interestRequired: "Pilih setidaknya satu minat.", nameAndEmailRequired: "Nama dan email wajib diisi.", emailInvalid: "Masukkan alamat email yang valid.", emailRequired: "Email wajib diisi.", passwordRequired: "Kata sandi wajib diisi.", passwordMinLength: "Kata sandi harus memiliki setidaknya {{min}} karakter.", otpSixDigits: "OTP harus berupa kode 6 digit.", newPasswordMinLength: "Kata sandi baru harus memiliki setidaknya {{min}} karakter.", verificationCodeRequired: "Kode verifikasi wajib diisi." },
  tr: { nameRequired: "Ad gerekli.", fieldRequired: "{{field}} gerekli.", nameInvalid: "Ad bir harfle başlamalı ve yalnızca sayılardan oluşmamalıdır.", ageRange: "Yaş {{min}} ile {{max}} arasında olmalıdır.", heightFtInRequired: "Boy (ft/in) gerekli.", selectOption: "Devam etmek için bir seçenek belirleyin.", completeQuestions: "Devam etmeden önce tüm soruları tamamlayın.", interestRequired: "En az bir ilgi alanı seçin.", nameAndEmailRequired: "Ad ve e-posta gerekli.", emailInvalid: "Geçerli bir e-posta adresi girin.", emailRequired: "E-posta gerekli.", passwordRequired: "Parola gerekli.", passwordMinLength: "Parola en az {{min}} karakter olmalıdır.", otpSixDigits: "OTP 6 haneli bir kod olmalıdır.", newPasswordMinLength: "Yeni parola en az {{min}} karakter olmalıdır.", verificationCodeRequired: "Doğrulama kodu gerekli." },
  te: { nameRequired: "పేరు అవసరం.", fieldRequired: "{{field}} అవసరం.", nameInvalid: "పేరు అక్షరంతో ప్రారంభం కావాలి మరియు కేవలం సంఖ్యలు మాత్రమే ఉండకూడదు.", ageRange: "వయస్సు {{min}} మరియు {{max}} మధ్య ఉండాలి.", heightFtInRequired: "ఎత్తు (అడుగులు/అంగుళాలు) అవసరం.", selectOption: "కొనసాగడానికి ఒక ఎంపికను ఎంచుకోండి.", completeQuestions: "కొనసాగించే ముందు అన్ని ప్రశ్నలను పూర్తి చేయండి.", interestRequired: "కనీసం ఒక ఆసక్తిని ఎంచుకోండి.", nameAndEmailRequired: "పేరు మరియు ఇమెయిల్ అవసరం.", emailInvalid: "చెల్లుబాటు అయ్యే ఇమెయిల్ చిరునామాను నమోదు చేయండి.", emailRequired: "ఇమెయిల్ అవసరం.", passwordRequired: "పాస్‌వర్డ్ అవసరం.", passwordMinLength: "పాస్‌వర్డ్ కనీసం {{min}} అక్షరాలు ఉండాలి.", otpSixDigits: "OTP 6 అంకెల కోడ్ అయి ఉండాలి.", newPasswordMinLength: "కొత్త పాస్‌వర్డ్ కనీసం {{min}} అక్షరాలు ఉండాలి.", verificationCodeRequired: "ధృవీకరణ కోడ్ అవసరం." },
  pa: { nameRequired: "ਨਾਮ ਲਾਜ਼ਮੀ ਹੈ।", fieldRequired: "{{field}} ਲਾਜ਼ਮੀ ਹੈ।", nameInvalid: "ਨਾਮ ਅੱਖਰ ਨਾਲ ਸ਼ੁਰੂ ਹੋਣਾ ਚਾਹੀਦਾ ਹੈ ਅਤੇ ਸਿਰਫ਼ ਅੰਕ ਨਹੀਂ ਹੋ ਸਕਦਾ।", ageRange: "ਉਮਰ {{min}} ਅਤੇ {{max}} ਦੇ ਵਿਚਕਾਰ ਹੋਣੀ ਚਾਹੀਦੀ ਹੈ।", heightFtInRequired: "ਕੱਦ (ਫੁੱਟ/ਇੰਚ) ਲਾਜ਼ਮੀ ਹੈ।", selectOption: "ਜਾਰੀ ਰੱਖਣ ਲਈ ਇੱਕ ਵਿਕਲਪ ਚੁਣੋ।", completeQuestions: "ਜਾਰੀ ਰੱਖਣ ਤੋਂ ਪਹਿਲਾਂ ਸਾਰੇ ਸਵਾਲ ਪੂਰੇ ਕਰੋ।", interestRequired: "ਘੱਟੋ-ਘੱਟ ਇੱਕ ਦਿਲਚਸਪੀ ਚੁਣੋ।", nameAndEmailRequired: "ਨਾਮ ਅਤੇ ਈਮੇਲ ਲਾਜ਼ਮੀ ਹਨ।", emailInvalid: "ਵੈਧ ਈਮੇਲ ਪਤਾ ਦਰਜ ਕਰੋ।", emailRequired: "ਈਮੇਲ ਲਾਜ਼ਮੀ ਹੈ।", passwordRequired: "ਪਾਸਵਰਡ ਲਾਜ਼ਮੀ ਹੈ।", passwordMinLength: "ਪਾਸਵਰਡ ਵਿੱਚ ਘੱਟੋ-ਘੱਟ {{min}} ਅੱਖਰ ਹੋਣੇ ਚਾਹੀਦੇ ਹਨ।", otpSixDigits: "OTP 6 ਅੰਕਾਂ ਦਾ ਕੋਡ ਹੋਣਾ ਚਾਹੀਦਾ ਹੈ।", newPasswordMinLength: "ਨਵੇਂ ਪਾਸਵਰਡ ਵਿੱਚ ਘੱਟੋ-ਘੱਟ {{min}} ਅੱਖਰ ਹੋਣੇ ਚਾਹੀਦੇ ਹਨ।", verificationCodeRequired: "ਤਸਦੀਕ ਕੋਡ ਲਾਜ਼ਮੀ ਹੈ।" },
  fa: { nameRequired: "نام الزامی است.", fieldRequired: "{{field}} الزامی است.", nameInvalid: "نام باید با یک حرف شروع شود و نمی‌تواند فقط شامل اعداد باشد.", ageRange: "سن باید بین {{min}} و {{max}} باشد.", heightFtInRequired: "قد (فوت/اینچ) الزامی است.", selectOption: "برای ادامه یک گزینه انتخاب کنید.", completeQuestions: "پیش از ادامه، به همه پرسش‌ها پاسخ دهید.", interestRequired: "حداقل یک علاقه‌مندی انتخاب کنید.", nameAndEmailRequired: "نام و ایمیل الزامی هستند.", emailInvalid: "یک نشانی ایمیل معتبر وارد کنید.", emailRequired: "ایمیل الزامی است.", passwordRequired: "رمز عبور الزامی است.", passwordMinLength: "رمز عبور باید حداقل {{min}} نویسه داشته باشد.", otpSixDigits: "OTP باید یک کد ۶ رقمی باشد.", newPasswordMinLength: "رمز عبور جدید باید حداقل {{min}} نویسه داشته باشد.", verificationCodeRequired: "کد تأیید الزامی است." },
  ur: { nameRequired: "نام ضروری ہے۔", fieldRequired: "{{field}} ضروری ہے۔", nameInvalid: "نام کا آغاز حرف سے ہونا چاہیے اور صرف اعداد پر مشتمل نہیں ہو سکتا۔", ageRange: "عمر {{min}} اور {{max}} کے درمیان ہونی چاہیے۔", heightFtInRequired: "قد (فٹ/انچ) ضروری ہے۔", selectOption: "جاری رکھنے کے لیے ایک اختیار منتخب کریں۔", completeQuestions: "جاری رکھنے سے پہلے تمام سوالات مکمل کریں۔", interestRequired: "کم از کم ایک دلچسپی منتخب کریں۔", nameAndEmailRequired: "نام اور ای میل ضروری ہیں۔", emailInvalid: "درست ای میل پتہ درج کریں۔", emailRequired: "ای میل ضروری ہے۔", passwordRequired: "پاس ورڈ ضروری ہے۔", passwordMinLength: "پاس ورڈ میں کم از کم {{min}} حروف ہونے چاہییں۔", otpSixDigits: "OTP چھ ہندسوں کا کوڈ ہونا چاہیے۔", newPasswordMinLength: "نئے پاس ورڈ میں کم از کم {{min}} حروف ہونے چاہییں۔", verificationCodeRequired: "تصدیقی کوڈ ضروری ہے۔" },
  he: { nameRequired: "נדרש שם.", fieldRequired: "השדה {{field}} הוא שדה חובה.", nameInvalid: "השם חייב להתחיל באות ואינו יכול להכיל מספרים בלבד.", ageRange: "הגיל חייב להיות בין {{min}} ל-{{max}}.", heightFtInRequired: "נדרש גובה (רגל/אינץ').", selectOption: "יש לבחור אפשרות כדי להמשיך.", completeQuestions: "יש להשלים את כל השאלות לפני שממשיכים.", interestRequired: "יש לבחור לפחות תחום עניין אחד.", nameAndEmailRequired: "נדרשים שם ודוא״ל.", emailInvalid: "יש להזין כתובת דוא״ל תקינה.", emailRequired: "נדרשת כתובת דוא״ל.", passwordRequired: "נדרשת סיסמה.", passwordMinLength: "הסיסמה חייבת להכיל לפחות {{min}} תווים.", otpSixDigits: "OTP חייב להיות קוד בן 6 ספרות.", newPasswordMinLength: "הסיסמה החדשה חייבת להכיל לפחות {{min}} תווים.", verificationCodeRequired: "נדרש קוד אימות." },
};

const defaultValidationMessages = validationMessages.en;
const resourceMap = resources as Record<string, { translation: Record<string, unknown> }>;

Object.entries(resourceMap).forEach(([language, resource]) => {
  const title = typeof resource.translation.validation === "string"
    ? resource.translation.validation
    : defaultValidationMessages.title ?? "Validation";
  const legacyRequired = typeof resource.translation.enterRequiredFields === "string"
    ? resource.translation.enterRequiredFields
    : defaultValidationMessages.fieldRequired;

  resource.translation.validation = {
    title,
    ...defaultValidationMessages,
    // Every selectable bundle already has this reviewed required-fields copy.
    // Reuse it until its field-specific counterpart is supplied below.
    fieldRequired: legacyRequired,
    nameRequired: legacyRequired,
    emailRequired: legacyRequired,
    passwordRequired: legacyRequired,
